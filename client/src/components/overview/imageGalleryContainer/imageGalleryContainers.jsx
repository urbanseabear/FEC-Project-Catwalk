  ...
  componentDidUpdate(prevProps) {
    if (this.props.photos !== prevProps.photos) {
      ...
      this.setState({
        ...
        midpoint: linkedListPhotos.thumbnails.length % 2 === 1 
    ...
    if (this.state.thumbnails) {
      return (
        ...
        <div 
          ...
          style={{
            backgroundImage: `url(${this.state.thumbnails.thumbnails[this.state.midpoint].value['url']})`, 
          ...
          onClick={(e) => {
            if (e.target.id !== 'arrows') {
              if (!this.state.expandedView) {
                ...
                setTimeout(() => this.imageRef.current.style.gridColumn = '1/3', 500);
                ...
                this.onExpandedViewClick.bind(this, e)();
                setTimeout(() => { this.imageRef.current.style.gridColumn = '1'; this.imageRef.current.style.width = '100%'; }, 500);
                this.imageRef.current.style.width = `${this.props.window.width * .6}px`;
          ...
          <ViewsContainer 
            thumbnailPhotos={this.state.thumbnails.thumbnails.map(({ value })=> value['thumbnail_url'])}
          ...
          <div style={{gridColumn: '2', display: 'flex', justifyContent: 'space-between'}}>
            <div className='leftArrowContainer' >
              <img id='arrows' src='./images/chevron-left.png' style={{maxWidth: '100%', backgroundColor: 'white', borderRadius: '50%', padding: '2px', maxWidth: '20px', maxHeight: '20px', cursor: 'pointer'}} onClick={this.onClickPrev.bind(this)} />
            </div>
            {/* <MainImage 
            ...
            <div className='rightArrowContainer'>
              <img id='arrows' src='./images/chevron-right.png' style={{backgroundColor: 'white', borderRadius: '50%', padding: '2px', maxWidth: '20px', maxHeight: '20px', cursor: 'pointer'}} onClick={this.onClickNext.bind(this)} />
            </div>
          </div>
        </div>
      );
